...
namespace SQLite.Tests {
    ...
    public class SguidTests {
		...
		[Test]
		public void ShouldPersistGuidAndReadSguid() {
			var db = new TestDb(TestPath.GetTempFileName());

			var obj1 = new TestObj() { Id=new Sguid("36473164-C9E4-4CDF-B266-A0B287C85623"), Text = "First Sguid Object" };
			var obj2 = new TestObj() {  Id=new Sguid("BC5C4C4A-CA57-4B61-8B53-9FD4673528B6"), Text = "Second Sguid Object" };
		...
		[Test]
        public void ShouldPersistAndReadSguid() {
            var db = new TestDb(TestPath.GetTempFileName());

            var obj1 = new TestObj() { Id=new Sguid(new Guid("36473164-C9E4-4CDF-B266-A0B287C85623")), Text = "First Sguid Object" };
            var obj2 = new TestObj() {  Id=new Sguid(new Guid("BC5C4C4A-CA57-4B61-8B53-9FD4673528B6")), Text = "Second Sguid Object" };
        ...
        public void AutoGuid_HasSguid() {
            ...
            var guid1 = new Sguid("36473164-C9E4-4CDF-B266-A0B287C85623");
            var guid2 = new Sguid("BC5C4C4A-CA57-4B61-8B53-9FD4673528B6");
        ...
        public void AutoGuid_EmptySguid() {
			...
			TestObj obj1 = null;
			try {
				obj1 = new TestObj (); // { Text = "First Guid Object" };
				obj1.Text = "First Guid Object";
			} catch (Exception e) {
				Console.Write(e);
			}
            var obj2 = new TestObj() { Text = "Second Guid Object" };

            Assert.AreEqual(Sguid.Empty, obj1.Id);
            Assert.AreEqual(Sguid.Empty, obj2.Id);
